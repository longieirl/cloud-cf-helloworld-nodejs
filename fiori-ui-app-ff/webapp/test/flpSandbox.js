		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#testcomsapze2effldv2odataec1abap-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"testcomsapze2effldv2odataec1abap-display": {
								"semanticObject": "testcomsapze2effldv2odataec1abap",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=test.com.sap.ze2effldv2odataec1abap",
									"url": sap.ui.require.toUrl("test/com/sap/ze2effldv2odataec1abap")
								}
							}
						}
					}
